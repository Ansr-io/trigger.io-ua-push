...
forge.urbanairship = {
    ...
    // ------------------------------------------------------------
    isPushEnabled: function (success, error) {
        // tested:ok
        // no need for success, error callbacks
        // just return a boolean, so:
        // enabled = forge.odr_ua.isPushEnabled();
        // ...same for all these 'is' methods
        //
        // also, noticed that the signature of isPushEnabled at https://github.com/urbanairship/phonegap-ua-push
        // is just isPushEnabled(function (enabled) {});
        // which would also be totally fine.
        //
    },
    isSoundEnabled: function ( success, error) {},
    isVibrateEnabled: function ( success, error) {},
    isQuietTimeEnabled: function ( success, error) {},
    isInQuietTime: function ( success, error) {},
    isLocationEnabled: function ( success, error) {},
    isBackgroundLocationEnabled: function ( success, error) {},
    // ------------------------------------------------------------
    getIncoming: function ( success, error) {
        // tested:working
        // Will bring up any existing notification if launched from one
    ...
    setTags: function (tags, success, error) {
        ...
        // { tags: Array }
        //
        // NB. tags is JSON encoded - should be javascript object
        // i.e. shouldnt need to call JSON.parse(tags)
        //
    },
    setSoundEnabled: function (text, success, error) {
        // untested
        // expected arguments: [enabled, callback]
        //
        // Note: Android Only, iOS sound settings come in the push
        // Set whether the device makes sound on push.
    },
